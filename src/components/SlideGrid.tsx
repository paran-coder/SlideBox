...
function SlideCard({ dirHandle, item, tagsById }: SlideCardProps) {
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col gap-1 rounded-lg border border-neutral-200 p-2 shadow-sm transition-shadow hover:z-20 hover:border-neutral-300 hover:shadow-md"
    >
      <div className="overflow-hidden rounded bg-neutral-100 shadow-none transition-transform duration-150 ease-out motion-reduce:transition-none group-hover:scale-[3] group-hover:shadow-2xl">
        {url && (
